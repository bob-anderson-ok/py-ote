...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 4598, 999))
        ...
        self.markBgdRegionButton = QtWidgets.QPushButton(self.layoutWidget)
        self.markBgdRegionButton.setObjectName("markBgdRegionButton")
        self.horizontalLayout_20.addWidget(self.markBgdRegionButton)
        self.clearBkgndsButton = QtWidgets.QPushButton(self.layoutWidget)
        self.clearBkgndsButton.setEnabled(False)
        self.clearBkgndsButton.setObjectName("clearBkgndsButton")
        self.horizontalLayout_20.addWidget(self.clearBkgndsButton)
        self.calcBgndFromRegionsButton = QtWidgets.QPushButton(self.layoutWidget)
        self.calcBgndFromRegionsButton.setEnabled(False)
        self.calcBgndFromRegionsButton.setObjectName("calcBgndFromRegionsButton")
        self.horizontalLayout_20.addWidget(self.calcBgndFromRegionsButton)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.markBgdRegionButton.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt;\">This tool is primarily intended to be used with observations that have employed a \'GPS Flasher\' to provide timing for the video observation.&nbsp;A side effect of having an LED light up at the entrance of your telescope is that it will affect the background values of the target star (and others) and so make it more difficult to extract the best possible baseline statistics (mean and noise-sigma and noise-correlation-coefficients) which benefit from having more points involved in the calculation.&nbsp;This tool allows the user to tell PyOTE where the background values are reliable (unaffected by flashes,&nbsp;or wind gusts,&nbsp;or telescope jostling, etc) enough to be used during baseline statistics calculation.</span></p><p><span style=\" font-size:18pt;\">By repeatedly selecting pairs of points on the light curve being analyzed and clicking this button,&nbsp;the regions of \'reliable baseline data\' can be designated.&nbsp;They will be shown as darkish green points instead of the normal blue color.</span></p><p><span style=\" font-size:18pt; font-weight:600; color:#0000ff;\">NOTE:</span><span style=\" font-size:18pt;\"> Background regions marked on one curve are automatically applied to all curves. </span></p><p><span style=\" font-size:18pt;\">In general,&nbsp;normalization against a reference star should be performed first,&nbsp;then this operation.&nbsp;That will remove any \'trends\' that would affect the mean and noise-sigma.</span></p><p><span style=\" font-size:18pt;\">The procedure is simple: Click on two points,&nbsp;then this button.&nbsp;Rinse and repeat.</span></p><p><span style=\" font-size:18pt; font-weight:600; color:#0000ff;\">FYI:</span><span style=\" font-size:18pt;\"> One can also use this feature to calculate statistics on some set of points of interest (like a statistics in the event bottom) or for reference stars or ...</span></p></body></html>"))
        self.markBgdRegionButton.setText(_translate("MainWindow", "Mark bkgnd region"))
        self.clearBkgndsButton.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt;\">Clicking this button clears all \'background\' regions and any baseline statistics that may have been extracted by clicking on the </span><span style=\" font-size:18pt; font-weight:600; color:#0000ff;\">Calc baseline mean/sigma/corr coeffs</span><span style=\" font-size:18pt;\"> button.</span></p></body></html>"))
        self.clearBkgndsButton.setText(_translate("MainWindow", "Clear"))
        self.calcBgndFromRegionsButton.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt;\">When this button is clicked,&nbsp;all the points included in the marked \'background\' regions will be collected and used to calculate the baseline mean,&nbsp;noise-sigma,&nbsp;and the noise-correlation coefficients.&nbsp;Unless a \'trim\' is performed,&nbsp;these values will be used during error bar estimations and \'false-positive\' estimation.</span></p><p><span style=\" font-size:18pt;\">If a \'trim\' is performed,&nbsp;the baseline mean will be determind from the trimmed data,&nbsp;but the noise-sigma and noise-correlation coefficients extracted from the marked \'background\' regions will continue to override those obtained from the trimmed light-curve.</span></p></body></html>"))
        self.calcBgndFromRegionsButton.setText(_translate("MainWindow", "Calc baseline mean/sigma/corr coeffs"))

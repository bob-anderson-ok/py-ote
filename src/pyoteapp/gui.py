...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.manualTimestampCheckBox = QtWidgets.QCheckBox(self.centralwidget)
        ...
        self.manualEntryPushButton = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.readData = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.lightCurveNumberLabel = QtWidgets.QLabel(self.centralwidget)
        ...
        self.curveToAnalyzeSpinBox = QtWidgets.QSpinBox(self.centralwidget)
        ...
        self.showSecondaryCheckBox = QtWidgets.QCheckBox(self.centralwidget)
        ...
        self.secondarySelector = QtWidgets.QSpinBox(self.centralwidget)
        ...
        self.normLabel = QtWidgets.QLabel(self.centralwidget)
        ...
        self.showTimestampErrors = QtWidgets.QCheckBox(self.centralwidget)
        ...
        self.enableTooltipsCheckBox = QtWidgets.QCheckBox(self.centralwidget)
        ...
        self.doBlockIntegration = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.acceptBlockIntegration = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.setDataLimits = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.smoothSecondaryButton = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.numSmoothPointsEdit = QtWidgets.QLineEdit(self.centralwidget)
        ...
        self.normalizeButton = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.markDzone = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.markRzone = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.calcFlashEdge = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.minEventLabel = QtWidgets.QLabel(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.minEventEdit = QtWidgets.QLineEdit(self.centralwidget)
        ...
        self.maxEventLabel = QtWidgets.QLabel(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.maxEventEdit = QtWidgets.QLineEdit(self.centralwidget)
        ...
        self.calcErrBars = QtWidgets.QPushButton(self.centralwidget)

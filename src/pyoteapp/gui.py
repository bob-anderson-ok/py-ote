...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.detectDurationLabel = QtWidgets.QLabel(self.tab_8)
        ...
        self.plainTextEdit = QtWidgets.QPlainTextEdit(self.tab_8)
        self.plainTextEdit.setMinimumSize(QtCore.QSize(0, 350))
        ...
        self.gridLayout_6.addWidget(self.calcDetectabilityButton, 3, 1, 1, 1)
        ...
        spacerItem28 = QtWidgets.QSpacerItem(20, 247, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        spacerItem29 = QtWidgets.QSpacerItem(113, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem30 = QtWidgets.QSpacerItem(190, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem32 = QtWidgets.QSpacerItem(113, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_2.addItem(spacerItem32, 3, 2, 1, 1)
        ...
        spacerItem36 = QtWidgets.QSpacerItem(20, 259, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_2.addItem(spacerItem36, 7, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.detectMagDropLabel.setToolTip(_translate("MainWindow", "<html><head/><body><p>Enter the expected magDrop as a postive number.</p></body></html>"))
        self.detectMagDropLabel.setText(_translate("MainWindow", "  magDrop:"))
        self.plainTextEdit.setPlainText(_translate("MainWindow", "Use the following functions to extract light-curve mean and noise values.\n"
"\n"
"You can use these results to report a simple baseline SNR when no event is present (or has been avoided by selection).\n"
"\n"
"These results are then available for use in calculating the minimum event that can be detected for a specified mag drop.\n"
"\n"
"If the predicted duration of an event is smaller than the minimum detectable duration, do not report a miss. Instead, report a \'no observation\'."))
        ...
        self.ne3ExplanationButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>The Night Eagle 3 is a rolling shutter CMOS camera. As a result, with this camera, the timing of an occultation depends on which row the occulted star is at when the occultation occurs. PyOTE will automatically calculate the needed time correction from the y (row) position that you enter in the spin/entry box at the bottom of this tab.</p><p>For the Night Eagle 3, times extracted by PyOTE require only a VTI correction (if you use an IOTA VTI, there is no correction at all needed).</p><p>Note: if the recording was <span style=\" font-weight:600;\">not</span> made with a tracking telescope (so the targer star is moving across the image), you will need to watch the video and record the row of the occultation for use in this program. Normally, with a tracking telescope, you will be able to use the y position of the \'target\' aperture directly. PyMovie includes this information in the comment lines of the csv file.</p><p>The Night Eagle 3 has a very effective noise reduction system called DNR (Dynamic Noise Reduction). There are 4 levels of noise reduction and you will need to indicate on this tab page what DNR setting your recording was made with.</p><p>The noise reduction is not without a small cost however - the edges of an occultation lightcurve will no longer be a step change. Instead, the edges will follow an exponential curve, approaching maximum and minimum intensities asymptotically. PyOTE has the abilty to fit such an exponential curve to the D and R transitions, so the time resolution will be retored during the least squares fit and you should feel free to use whatever level of noise reduction you may need. It is recomment that you run your NE3 at a gamma of 0.75 (1.0 gamma is not available) AND that you use PyMovie to linearize the recording (i.e., invert the 0.75 gamma curve of the camera).</p><p>The D and R exponential curves each have their own time constant, measured in frames, that control the frame rate of exponential curve growth. The defualt values provided are usually enough to provide a good fit, but you can change them to better fit the edges produced by your particular camera - any such values entered are saved when you close the program and restored when it is reopened.</p><p>When the exponential curve fit algorithm is in use, the lightcurve plot PyOTE displays will be changed. Gone is the blue \'camera response\' curve, replaced by brown dotted \'theroetical\' exponential edge curves that you can use to judge for yourself the goddness of a \'fit\'.</p><p><span style=\" color:#fc0107;\">You will probably want to use the most aggressive noise reduction in most cases, but make sure that your expected event duration is long enough that the D transition exponential curve has time to settle to the bottom event plus some time to allow a good determination of the event bottom intensity. At DNR:HIGH, your expected event time should be grater than 30 frames (1 second) to use this setting.</span></p></body></html>"))
        ...
        self.dnrLowDtcLabel.setText(_translate("MainWindow", "TC:D"))
        self.dnrLowRtcLabel.setText(_translate("MainWindow", "TC:R"))
        self.dnrMiddleRadioButton.setText(_translate("MainWindow", "DNR: Middle"))
        self.dnrMiddleDtcLabel.setText(_translate("MainWindow", "TC:D"))
        self.dnrMiddleRtcLabel.setText(_translate("MainWindow", "TC:R"))
        self.dnrHighRadioButton.setText(_translate("MainWindow", "DNR: High"))
        self.dnrHighDtcLabel.setText(_translate("MainWindow", "TC:D"))
        self.dnrHighRtcLabel.setText(_translate("MainWindow", "TC:R"))

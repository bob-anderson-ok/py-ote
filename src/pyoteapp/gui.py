...
# Form implementation generated from reading ui file 'simple_plot2Scrollable.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 4634, 999))
        ...
        self.horizontalLayout_8.addWidget(self.penumbralFitCheckBox)
        ...
        self.horizontalLayout_8.addWidget(self.locateEvent)
        ...
        self.horizontalLayout_8.addWidget(self.calcErrBars)
        ...
        self.horizontalLayout_8.addWidget(self.fillExcelReportButton)
        ...
        self.horizontalLayout_20.addWidget(self.markBaselineRegionButton)
        ...
        self.horizontalLayout_20.addWidget(self.clearBaselineRegionsButton)
        ...
        self.horizontalLayout_20.addWidget(self.calcStatsFromBaselineRegionsButton)
        ...
        self.horizontalLayout_16.addWidget(self.startOver)
        ...
        self.horizontalLayout_16.addWidget(self.writePlot)
        ...
        self.horizontalLayout_16.addWidget(self.writeBarPlots)
        ...
        self.horizontalLayout_16.addWidget(self.writeCSVButton)
        ...
        self.horizontalLayout_17.addWidget(self.splitter_3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tutorialButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>Tip: right-click on buttons and labels.&nbsp;An explanation (help screen) will usually appear.&nbsp;Use that technique to learn about features that are not covered in this basic tutorial/recipe.<br/></p><p>1. Start by clicking the <span style=\" font-weight:600; color:#0000ff;\">Read light curve button </span></p><p><span style=\" color:#000000;\">2. If timestamp errors have been detected during the loading of the csv file,&nbsp;the affected points will be bracketed by vertical redlines and the </span><span style=\" font-weight:600; color:#0000ff;\">Show time err</span><span style=\" color:#000000;\"> checkbox will have been set by the program.&nbsp;Those red lines will likely have served their purpose and should be turned off so that a clear view of the light-curve is presented.</span></p><p><span style=\" color:#000000;\">3. If the csv file contained multiple light-curves (it usually will),&nbsp;you may need to click the </span><span style=\" font-weight:600; color:#0000ff;\">Light curve to analyze</span><span style=\" color:#000000;\"> spinner to advance to the light-curve that contains the event.</span></p><p><span style=\" color:#000000;\">4. The next step is to give the \'event finder\' information that can speed up the search. </span></p><p><span style=\" color:#000000;\">4a. If the event has a wide enough bottom,&nbsp;the quickest way to provide speed-up information is mark the D and R regions.&nbsp;Right-click on those buttons for a how-to.</span></p><p><span style=\" color:#000000;\">4b. If the event is so small that it is hard or impossible to mark D and R regions,&nbsp;the speed-up information is then best supplied by placing the smallest event duration in the </span><span style=\" font-weight:600; color:#0000ff;\">min event duration</span><span style=\" color:#000000;\"> edit box and the maximum event duration in the </span><span style=\" font-weight:600; color:#0000ff;\">max event duration</span><span style=\" color:#000000;\"> edit box.&nbsp;The \'finder\' will then search for all events in the range of durations given, located anywhere in the light-curve.</span></p><p><span style=\" color:#000000;\">5. Next,&nbsp;click the </span><span style=\" font-weight:600; color:#0000ff;\">Find event, then ...</span><span style=\" color:#000000;\"> button to initiate the search.</span></p><p><span style=\" color:#000000;\">6. Assuming the search was successful,&nbsp;the final step is to click the </span><span style=\" font-weight:600; color:#0000ff;\">... write report</span><span style=\" color:#000000;\"> button.</span></p><p><span style=\" color:#000000;\">Every step you took is recorded in a log file in the directory where the light-curve was read from.&nbsp;This is important information to provide to anyone that you might go to for assistance.&nbsp;Give them the csv file and the log file and they will be able to reproduce your session.</span></p></body></html>"))
        ...
        self.showTimestampErrors.setText(_translate("MainWindow", "Show time err "))
        ...
        self.showUnderlyingLightcurveCheckBox.setText(_translate("MainWindow", "Show raw light"))
        ...
        self.showErrBarsCheckBox.setText(_translate("MainWindow", "Show err bars"))
        ...
        self.showEdgesCheckBox.setText(_translate("MainWindow", "Show edges"))
        ...
        self.markDzone.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-family:\'arial,sans-serif\'; color:#222222;\">Select two points in the primary (dark blue) light curve,&nbsp;one on each side of where the star ‘disappears’,&nbsp;then click this button to create a D search area.</span></p><p><span style=\" font-family:\'arial,sans-serif\'; color:#222222;\">If no points are selected,&nbsp;a search for a D transition will not be performed --- this becomes an \'R only\' event.</span></p><p><span style=\" font-family:\'arial,sans-serif\'; color:#222222;\">If the event duration is so short that it is difficult to place D and R regions,&nbsp;you should use the min event duration edit box and the max event duration edit box to give guidance to the \'finder\'.</span></p></body></html>"))
        self.markDzone.setText(_translate("MainWindow", "Mark D region"))
        self.markRzone.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-family:\'arial,sans-serif\'; color:#222222;\">Select two points in the primary (dark blue) light curve,&nbsp;one on each side of where the star ‘reappears’,&nbsp;then click this button to create an R search area.</span></p><p><span style=\" font-family:\'arial,sans-serif\'; color:#222222;\">If no points are selected,&nbsp;a search for an R transition will not be performed --- this becomes a \'D only\' event.</span></p><p><span style=\" font-family:\'arial,sans-serif\'; color:#222222;\">If the event duration is so short that it is difficult to place D and R regions,&nbsp;you should use the min event duration edit box and the max event duration edit box to give guidance to the \'finder\'.</span></p></body></html>"))
        ...
        self.minEventLabel.setToolTip(_translate("MainWindow", "<html><head/><body><p>Use this entry to tell the \'finder\' the smallest event duration (in points) to look for.&nbsp;It\'s okay to set this to 1 but if the smallest possible duration is clearly a much bigger number,&nbsp;you will save time during the solution search phase to use a more realistic number.</p></body></html>"))
        self.minEventLabel.setText(_translate("MainWindow", "min event duration:"))
        ...
        self.maxEventLabel.setToolTip(_translate("MainWindow", "<html><head/><body><p>Use this entry to tell the \'finder\' the largest event duration (in points) to look for.&nbsp;It\'s okay to set this to a large number,&nbsp;but if the largest possible duration is clearly a much smaller number,&nbsp;you will save time during the solution search phase to use a more realistic number.</p></body></html>"))
        self.maxEventLabel.setText(_translate("MainWindow", "max event duration:"))

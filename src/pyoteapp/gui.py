...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_5.addItem(spacerItem47, 0, 2, 1, 1)
        ...
        self.gridLayout_5.addItem(spacerItem48, 5, 4, 2, 1)
        ...
        self.gridLayout_5.addItem(spacerItem49, 11, 0, 2, 1)
        ...
        self.gridLayout_5.addItem(spacerItem53, 22, 3, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.allowNewVersionPopupCheckbox.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt; font-weight:600; color:#0000ff;\">What\'s new:</span></p><p><span style=\" font-size:18pt; font-weight:600; color:#fc0107;\">This version contains many new changes in the GUI and analysis features. Be sure and read all the applicable help by clicking on applicable HELP buttons and by right-clicking on text labels of new features.</span></p><p>This popup can be disabled in the Settings/Misc tab. There is a checkbox provided there for this function. Note: right click on that checkbox at any time to see the new vesion description.</p></body></html>"))

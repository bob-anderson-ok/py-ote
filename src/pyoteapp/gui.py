...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.readData, 0, 2, 1, 1)
        ...
        self.plotHelpButton = QtWidgets.QPushButton(self.widget)
        ...
        self.showUnderlyingLightcurveCheckBox = QtWidgets.QCheckBox(self.widget)
        ...
        self.penumbralFitCheckBox = QtWidgets.QCheckBox(self.widget)
        ...
        self.viewFrameButton = QtWidgets.QPushButton(self.widget)
        ...
        self.frameNumSpinBox = QtWidgets.QSpinBox(self.widget)
        ...
        self.fieldViewCheckBox = QtWidgets.QCheckBox(self.widget)
        ...
        self.flipYaxisCheckBox = QtWidgets.QCheckBox(self.widget)
        ...
        self.flipXaxisCheckBox = QtWidgets.QCheckBox(self.widget)
        ...
        self.underlyingLightcurveLabel = QtWidgets.QLabel(self.widget)
        ...
        self.demoUnderlyingLighturvesButton = QtWidgets.QPushButton(self.widget)
        ...
        self.enableDiffractionCalculationBox = QtWidgets.QCheckBox(self.widget)
        ...
        self.asteroidDistanceLabel = QtWidgets.QLabel(self.widget)
        ...
        self.asteroidDistanceEdit = QtWidgets.QLineEdit(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.starDiameterLabel = QtWidgets.QLabel(self.widget)
        ...
        self.starDiameterEdit = QtWidgets.QLineEdit(self.widget)
        ...
        self.dLimbAngleLabel = QtWidgets.QLabel(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.dLimbAngleEdit = QtWidgets.QLineEdit(self.widget)
        self.dLimbAngleEdit.setMaximumSize(QtCore.QSize(60, 16777215))
        self.dLimbAngleEdit.setText("")
        self.dLimbAngleEdit.setObjectName("dLimbAngleEdit")
        self.horizontalLayout_14.addWidget(self.dLimbAngleEdit)
        self.rLimbAngleLabel = QtWidgets.QLabel(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.rLimbAngleEdit = QtWidgets.QLineEdit(self.widget)
        self.rLimbAngleEdit.setMaximumSize(QtCore.QSize(60, 16777215))
        self.rLimbAngleEdit.setText("")
        self.rLimbAngleEdit.setObjectName("rLimbAngleEdit")
        self.horizontalLayout_14.addWidget(self.rLimbAngleEdit)
        ...
        self.helpLabelForDataGrid = QtWidgets.QLabel(self.widget)
        self.helpLabelForDataGrid.setObjectName("helpLabelForDataGrid")
        self.verticalLayout.addWidget(self.helpLabelForDataGrid)
        ...
        self.horizontalLayout_15.addWidget(self.mainPlot)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.showUnderlyingLightcurveCheckBox.setText(_translate("MainWindow", "Show underlying lightcurve"))
        ...
        self.penumbralFitCheckBox.setToolTip(_translate("MainWindow", "<html><head/><body><p>If an occultation involves a star that is not point-like (has a detectable disk), the observation lightcurve will often have a gradual transition and take more than one or two readings for the disappearance and/or reappearance to occur. To extract timing data from such an observation, an underlying lightcurve model that incorporates star diameter (mas) and limb angles must be used.</p><p>This checkbox will be enabled whenever a star diameter is entered below AND the <span style=\" font-weight:600; color:#fc0107;\">Demo</span> button has been clicked.</p><p>Once this checkbox is checked, the <span style=\" font-weight:600; color:#fc0107;\">Find event, then ...</span> button will invoke a different \'find event\' methodology. When the \'penumbral fit\' methodology is active, the user is expected to:</p><p><span style=\" font-weight:600; color:#fc0107;\">1.</span> Carefully locate the D and or R regions so that the penumbral transition regions are precisely enclosed.</p><p>This allows PyOTE to identify/assume the points to the left and right of the D and/or R regions are proper baseline points so as to compute a correct baseline intensity and associated noise. This also allows the points between the D and/or R regions to be used for the computation of the correct event intensity and associated noise.</p><p><span style=\" font-weight:600; color:#fc0107;\">2.</span> Repeatedly click the <span style=\" font-weight:600; color:#fc0107;\">Find event, then ...</span> button, evalute the \'fit\' visually, and change the limb angles until satisfied, then</p><p><span style=\" font-weight:600; color:#fc0107;\">3.</span> Click the <span style=\" font-weight:600; color:#fc0107;\">... write report</span> button.</p><p>The D and/or R regions will remain active during step 2. They will be removed when <span style=\" font-weight:600; color:#fc0107;\">... write report</span> is clicked.</p><p>The D and/or R edge times will not change significantly during the step 2 iterations; they are only performed to get an estimate of the D and/or R limb angles, so a good visual fit should be adequate.</p></body></html>"))
        ...
        self.underlyingLightcurveLabel.setText(_translate("MainWindow", "set these parameters to incorporate diffraction and star disk effects"))
        self.demoUnderlyingLighturvesButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>This button demonstrates the underlying lightcurve used in determining the time of the geometric shadow edge given the observation parameters set in the edit boxes in this edit box group.</p><p>If values have been entered in the two boxes to the right (Ast dist, and speed), the diffraction lightcurve (based on a straight-edge model) that will \'seen\' by the camera will be computed and displayed.</p><p>We refer to this as the \'underlying lightcurve\': it is the theoretical intensity of the light diffracted at the occulting edge (assumed straight) as a function of time, i.e. as the shadow of the occulting body passes the observation position.</p><p>Diffraction intensity has a wavelength dependence. In PyOTE, we compute a generic diffraction curve composed of light wavelengths in the 400nm to 600nm range (using 5 nm steps) with equal intensities at each included wavelength. The region of the diffraction curve that is of most interest to us is only about +/- 1 Fresnel unit on either side of the geometrical shadow point. Fortunately, in that region, there is very little difference between a narrow band of light wavelengths and a wide band of light wavelengths, so there is no practical need to specify a more realistic bandpass in terms of either shape (amplitudes) or extent (bandpass). The primary effect of a wide bandpass is to greatly reduce the oscillations seen in a single wavelength diffraction curve (i.e., the one that is most frequently used to show diffraction effects).</p><p>If the star has a finite disk, the effect on the underlying lightcurve is usually very significant and apparent, \'integrating\' away most of the characteristic diffraction curve shape and moving toward what is often referred to as a penumbral shape. It also moves the value of the intensity at the geometrical shadow point from 25% of full scale up to something close to 50% of full scale.</p><p>If you leave the exposure duration (exp dur: edit box) empty, the result of clicking this button will be a display of the underlying light curve shape. To see the effect of the camera exposure time, which integrates the underlying light curve to produce what we refer to as the camera response, fill in the effective exposure time, taking into account the observation frame rate and number of frames being integrated. Note: this field will be updated/filled in automatically when an observation with timing data is loaded and, if necessary, integrated.</p><p>If this demo is run before \'solution\' baseline and event intensities have been determined, generic values of 100.0 (baseline intensity) and 0.0 (event intensity) are used. If \'real\' baseline and event intensities are available, they are used instead.</p></body></html>"))
        ...
        self.asteroidDistanceLabel.setToolTip(_translate("MainWindow", "<html><head/><body><p>Enter the distance to the asteroid/occulting body.</p><p>For distance units, use AU (Astronomical units)</p></body></html>"))
        self.asteroidDistanceLabel.setText(_translate("MainWindow", "  dist(AU):"))
        ...
        self.shadowSpeedLabel.setText(_translate("MainWindow", "  speed(km/sec):"))

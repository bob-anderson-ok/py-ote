...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.xOffsetSpinBox_1.setSingleStep(10)
        ...
        self.xOffsetSpinBox_2.setSingleStep(10)
        ...
        self.xOffsetSpinBox_3.setSingleStep(10)
        ...
        self.xOffsetSpinBox_4.setSingleStep(10)
        ...
        self.xOffsetSpinBox_5.setSingleStep(10)
        ...
        self.xOffsetSpinBox_6.setSingleStep(10)
        ...
        self.xOffsetSpinBox_7.setSingleStep(10)
        ...
        self.xOffsetSpinBox_8.setSingleStep(10)
        ...
        self.xOffsetSpinBox_9.setSingleStep(10)
        ...
        self.xOffsetSpinBox_10.setSingleStep(10)
        ...
        self.dotSizeSpinner.setMaximum(9)
        self.dotSizeSpinner.setProperty("value", 6)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lightcurvesHelpButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>This panel allows up to 10 lightcurves to be displayed at the same time. If the csv file has more than 10 lightcurves, the first 10 are displayed.</p><p>The<span style=\" font-weight:600; color:#0000ff;\"> targe</span>t lightcurve is always drawn with bright blue dots.</p><p>If a lightcurve is selected as a <span style=\" font-weight:600; color:#0000ff;\">reference</span> to be used for normalization, it is always drawn with bright green dots.</p><p>Unless a lightcurve is designated as a <span style=\" font-weight:600; color:#0000ff;\">target</span> (curve to be analyzed for an event) or is designated as a <span style=\" font-weight:600; color:#0000ff;\">reference</span> lightcurve, its dot color depends on the row it is in - every row has a unique color other than blue or green.</p><p>Lightcurves can be displaced up or down using the<span style=\" font-weight:600; color:#0000ff;\"> Y offset</span> spinner to control the displacement. This affects the display position only; the underlying values are not affected. This facility was added to allow the separation of lightcurves that would otherwise overlap in a confusing manner.</p><p>There can only be one lightcurve selected as <span style=\" font-weight:600; color:#0000ff;\">target</span>.</p><p>There can be either 0 or 1 lightcurve selected as a <span style=\" font-weight:600; color:#0000ff;\">reference</span> for normalization.</p><p>Normalization is applied whenever the<span style=\" font-weight:600; color:#0000ff;\"> normalization reference curve smoothing interval</span> spinbox is changed from 0. Whenever this number is changed, a new normalization will result. If this number is returned to zero, all normalization is removed and the original values restored.</p><p>The <span style=\" font-weight:600; color:#0000ff;\">X offset</span> spinbox is not yet implemented. Its (future) purpose is to allow the <span style=\" font-weight:600; color:#0000ff;\">reference</span> curve used for normalization to be \'time shifted\' for those cases where a drifting cloud affects lightcurves at slightly different times.</p></body></html>"))

...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.asteroidDistanceUnitsSelector = QtWidgets.QComboBox(self.diffractionTab)
        self.asteroidDistanceUnitsSelector.setMaxVisibleItems(2)
        self.asteroidDistanceUnitsSelector.setMinimumContentsLength(0)
        self.asteroidDistanceUnitsSelector.setObjectName("asteroidDistanceUnitsSelector")
        self.horizontalLayout_13.addWidget(self.asteroidDistanceUnitsSelector)
        ...
        self.redoFindEvent = QtWidgets.QPushButton(self.diffractionTab)
        self.redoFindEvent.setEnabled(False)
        self.redoFindEvent.setObjectName("redoFindEvent")
        self.horizontalLayout_16.addWidget(self.redoFindEvent)
        ...
        self.asteroidDistanceUnitsSelector.setCurrentIndex(-1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.asteroidDistanceLabel.setText(_translate("MainWindow", "  asteroid distance:"))
        self.asteroidDistanceUnitsSelector.setPlaceholderText(_translate("MainWindow", "parallax"))
        ...
        self.allowNewVersionPopupCheckbox.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600; color:#aa0000;\">What\'s new:</span></p><p><span style=\" color:#000000;\">In the diffraction tab: added a selection box so that asteroid distance can be entered either as parallax (arcseconds) or as AU.</span></p><p><span style=\" color:#000000;\">Reviewed and amended the context help on this tab to be more explanatory.</span></p><p><span style=\" font-weight:700; color:#0000ff;\">Older:</span></p><p><span style=\" color:#000000;\">Added a button to the diffraction tab to be used during penumbral fits to perform a re-fit. Also added better context help regarding the selection of D and R regions (cautioning user to only include points in the penumbral transition regions)</span></p><p><span style=\" color:#000000;\">Timestamp error lines now distinguish between \'cadence jitter\' and \'dropped frames\' by using an additional color.</span></p><p><span style=\" color:#000000;\">Cadence jitter happens when high frame rates create a situation where frame recording cannot keep up and the traffic control implemented by the computer changes the arrival/timestamp time of frames so that some appear a little earlier and others a little late.</span></p><p><span style=\" color:#000000;\">Cadence jitter is defined as a timing discrepancy of between 20% and 80% of a frame time and is represented by a yellow line.</span></p><p><span style=\" color:#000000;\">Timing discrepancies greater than 80% of a frame time continue to be shown as a red line and are assumed to come from dropped frames. In any case, they deserve attention.</span></p></body></html>"))

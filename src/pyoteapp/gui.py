...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.detectDurationLabel.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt;\">Enter the expected duration of the event in seconds (oa duration of 1.5 times the predicted duration is recommended). </span></p></body></html>"))

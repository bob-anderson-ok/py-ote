...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_13.addWidget(self.mainPlot)
        self.splitterOne = QtWidgets.QSplitter(self.splitter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.viewFrameButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>Use this button to view a frame from the video that was used by PyMovie to prepare the csv file that is currently being analyzed.  Currently .avi and .ser files are viewable in this manner.</p><p>If this button is disabled, it is because the csv file did not come from PyMovie.</p></body></html>"))
        self.viewFrameButton.setText(_translate("MainWindow", "View frame:"))
        self.frameNumSpinBox.setToolTip(_translate("MainWindow", "<html><head/><body><p>Use this spin box (which may be directly editted) to select the frame to be viewed.</p><p>Frames are numbered starting at 0.</p><p>The upper limit for an allowed frame number is set when the csv is read.</p></body></html>"))
        ...
        self.flipYaxisCheckBox.setToolTip(_translate("MainWindow", "<html><head/><body><p>Checking this box will rotate the frame view around the horizontal axis. (Flips top to bottom.)</p></body></html>"))
        self.flipYaxisCheckBox.setText(_translate("MainWindow", "flip top/bottom"))
        self.flipXaxisCheckBox.setToolTip(_translate("MainWindow", "<html><head/><body><p>Check this box if it is necessary to rotate the image around the vertical axis. (Flip left to right.)</p></body></html>"))

...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.allowNewVersionPopupCheckbox.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600; color:#0000ff;\">What\'s new:</span></p><p><span style=\" font-weight:600; color:#fc0107;\">This version contains many new changes in the GUI and analysis features. Be sure and read all the applicable help by clicking on applicable HELP buttons and by right-clicking on text labels of new features.</span></p><p>This popup can be disabled in the Settings/Misc tab. There is a checkbox provided there for this function. Note: right click on that checkbox at any time to see the new version description.</p></body></html>"))

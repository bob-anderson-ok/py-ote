...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.infoButton.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt;\">Click this button to to open the </span><span style=\" font-size:18pt; color:#ff0000;\">help.pdf</span><span style=\" font-size:18pt;\"> file that is included in the installation. The file will open in whatever PDF viewer you have assigned as the default viewer for pdf files.</span></p><p><span style=\" font-size:18pt;\">The first part of this file is version info that should be examined every time a new version of PyOTE is installed.</span></p><p><span style=\" font-size:18pt;\">At the bottom of this version info is a brief introduction to PyOTE that should be read by new users.</span></p></body></html>"))
        ...
        self.readData.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt;\">PYOTE reads Limovie, R-OTE, and Tangra files and includes up to four light curves.</span></p><p><span style=\" font-size:18pt;\">Normally (but not required) object1 is the occulted star; other (optional) objects are reference stars to be used for normalizing the occulted star light curve or flash curves from an LED timer.</span></p><p><span style=\" font-size:18pt; font-weight:600; text-decoration: underline; color:#0000ff;\">Mouse button functions within the light curve plot:</span></p><p><span style=\" font-size:18pt; font-weight:600; color:#ff0000;\">Left click</span><span style=\" font-size:18pt;\">: selects/deselects points on the primary (dark blue) light curve that intersect with the vertical hairline (the mouse cursor is disabled).</span></p><p><span style=\" font-size:18pt; font-weight:600; color:#ff0000;\">Left click and drag</span><span style=\" font-size:18pt;\">: rectangular zoom is available to more clearly see points for selection (but point selection can also be accomplished through clicks in the tabular data display at the lower left)</span></p><p><span style=\" font-size:18pt; font-weight:600;\">Note! The shift key will toggle the mouse cursor on/off in the light curve plot.</span><span style=\" font-size:18pt;\"> This enables the starting corner for the zoom to be seen. (But points cannot be selected/deselected while the mouse cursor is visible. A right click will always \'blank\' the mouse cursor.) </span></p><p><span style=\" font-size:18pt; font-weight:600; color:#ff0000;\">Right click</span><span style=\" font-size:18pt;\">: undo zoom</span></p><p><span style=\" font-size:18pt; color:#996633;\">Timestamp errors are shown with vertical red hairlines when a file is first read. These will disappear after the first point is selected so that the working view is as clear as possible. The red hairlines will re-appear permanently after the error bars have been calculated and the final report written to the log.</span></p></body></html>"))
        self.readData.setText(_translate("MainWindow", "Read light curve"))
        self.helpButton.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt;\">\'Help\' is available for most GUI items by right-clicking on the item.</span></p><p><span style=\" font-size:18pt;\">If an item already has a different action assigned to a right-click, there will be a nearby text line that can be clicked on instead.</span></p><p><span style=\" font-size:18pt;\">Thee is no need to close the help panel before right-clicking on another GUI item. One can use this feature to get a quick survey of the \'help\' that is available by sequentially clicking on all GUI items.</span></p></body></html>"))
        self.helpButton.setText(_translate("MainWindow", "Help"))
        self.lightCurveNumberLabel.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt;\">Use this spinner to select which light curve to analyze for an occultation event or as a source for \'flash timing\' edges.</span></p></body></html>"))
        ...
        self.normLabel.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt;\">If there are multiple reference stars in the file, this spinner will activate to allow the choice of which one to display/use.</span></p></body></html>"))
        self.normLabel.setText(_translate("MainWindow", "for normalization (green)"))
        self.showTimestampErrors.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt;\">Timestamp errors are indicated by red lines that show where a time step is not within +/- 10% of the expected value.</span></p><p><span style=\" font-size:18pt;\">Sometimes there are so many red lines that is becomes hard to see the plot.  In that case, uncheck this box to suppress the red line display.</span></p></body></html>"))
        ...
        self.helpLabelForDataGrid.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt;\">Clicking at the left-edge of a data line will cause the corresponding data point in the main display to be highlighted.  Only one such point can be high-lighted at a time.</span></p><p><span style=\" font-size:18pt;\">Clicking a point in the main data plot will cause this data grid to be positioned at that data point with the row shown in red.  Clicking anywhere in this row will \'toggle\' the selection of that point, useful when the main data plot is very dense.</span></p></body></html>"))
